...
# gateCounts
Calculates Daily, Weekly, Monthly, Cumulative and Summary Statistics of Visitor Counts Provided Raw Daily Gate Counts
...
6.  ***runGateCount*** starts the Shiny app for this R packge. Under construction. 

7.  ***gateCountsVisMultipleInstitutes*** for creating plots comparing visitor counts from multiple institutes. Under construction. 
