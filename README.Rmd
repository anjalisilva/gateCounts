...
4.  ***gateCountsVisWeekly*** for creating plots showing visitor counts by week. Both count and log-transformed count plots are provided to help visualize trends.

5.  ***gateCountsVisMonthly*** for creating plots showing visitor counts by month. Both count and log-transformed count plots are provided to help visualize trends.

6.  ***runGateCount*** starts the Shiny app for this R package. Under construction. 

7.  ***gateCountsVisMultiple*** for creating plots comparing visitor counts from multiple institutes. Under construction. 
